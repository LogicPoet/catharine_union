...
//import com.catharine.common.secure.CatUser;
//import com.catharine.common.tool.*;
////import com.catharine.gateway.provider.IClientDetails;
////import com.catharine.gateway.provider.IClientDetailsService;
...
//    private static final String CAT_USER_REQUEST_ATTR = "_CAT_USER_REQUEST_ATTR_";
//
...
//     * @return BladeUser
//     */
//    public static CatUser getUser() {
//        HttpServletRequest request = WebUtil.getRequest();
//        if (request == null) {
//            return null;
//        }
//        // 优先从 request 中获取
//        Object catUser = request.getAttribute(CAT_USER_REQUEST_ATTR);
//        if (catUser == null) {
//            catUser = getUser(request);
//            if (catUser != null) {
//                // 设置到 request 中
//                request.setAttribute(CAT_USER_REQUEST_ATTR, catUser);
//            }
//        }
...
//     * @return BladeUser
//     */
//    public static CatUser getUser(HttpServletRequest request) {
...
//        catUser.setClientId(clientId);
//        catUser.setUserId(userId);
//        catUser.setTenantId(tenantId);
//        catUser.setAccount(account);
//        catUser.setRoleId(roleId);
//        catUser.setRoleName(roleName);
